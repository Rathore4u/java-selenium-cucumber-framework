Feature: E2E for Feature Story AESCIS-37962 - Creation and editing of warnings should be successful for Accent Client
  ...
  @SmokeSuite
  Scenario: E2E for Feature Story AESCIS-37962 - accountwarningadmin.aspx (Accent) [C25738207]
    ...
    When user navigates to URL : "${accentStagingWebsiteV3.url}/administration/warning/accountwarningadmin.aspx?custid=1265466" application
