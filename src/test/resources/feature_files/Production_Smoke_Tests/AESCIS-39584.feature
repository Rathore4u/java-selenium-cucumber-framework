Feature: E2E for Feature Story AESCIS-37827 - search.aspx(Spark)
    ...
    @SmokeSuite
    Scenario: TC01 - User is able to search accounts using "Account No", "Last Name" and "First Name" fields for Spark client - [25717460]
        ...
        When Enter AccountNo as "0030"
        And Click Search Button
        Then Check Show Results
        And Verify Results for "0030"
