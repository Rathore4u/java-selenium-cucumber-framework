Feature: E2E for Feature Story AESCIS-37847 - User is able to verify the exceptiontypeconfiguration.aspx page in Spark Application
  ...
  Scenario: User is able to verify the exceptiontypeconfiguration.aspx page in Stream Energy Application [C25726542]
    ...
    When Navigate to URL-> "${sparkStagingWebsiteV3.url}" /administration/correspondence/exceptiontypeconfiguration.aspx
