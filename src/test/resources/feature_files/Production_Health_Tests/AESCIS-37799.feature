Feature: E2E - Task Toaster Dashboard.PaymnentsDataMigrationTask - Stream

    // Auto generated by aurea-automation - util on Fri, 20 Sep 2019 13:17:57 GMT
    @HealthCheckSuite
    Scenario: [Stream] User is able to execute "PaymnentsDataMigration" task in Task Toaster website - [C25733948]
