Feature: E2E - Task Toaster InvoiceEngine.QueueClientInvoices task (Accent Client)

    // Auto generated by aurea-automation - util on Fri, 20 Sep 2019 13:17:57 GMT
    @HealthCheckSuite
    Scenario: [Accent] User is able to execute "QueueClientInvoices" task in Task Toaster website - [C25734326]
