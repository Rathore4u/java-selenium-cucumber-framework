Feature: E2E - Task Toaster InvoiceEngine.QueueClientInvoices task (Spark Client)

    // Auto generated by aurea-automation - util on Fri, 20 Sep 2019 13:17:57 GMT
    @HealthCheckSuite
    Scenario: [Spark] User is able to execute "QueueClientInvoices" task in Task Toaster website - [C25734319]
