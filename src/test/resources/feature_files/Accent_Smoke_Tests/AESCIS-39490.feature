Feature: E2E for Feature Story AESCIS-39490 - ratelist.aspx (Accent)   [1]
  ...
  @SmokeSuite
  Scenario: Make sure the Rate Search is working in RateList page for Accent Client. (Accent) - [C25735441]
    ...
    When Navigate to URL-> "${accentStagingWebsiteV3.url}" /callcenter/includes/ratelist.aspx
