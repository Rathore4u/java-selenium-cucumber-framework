Feature: E2E for Feature Story AESCIS-39550 exceptiontypeconfiguration.aspx (Accent)
  ...
  @SmokeSuite
  Scenario: User is able to verify the exceptiontypeconfiguration.aspx page in Accent Application - [C25722578]
    ...
    When Navigate to URL-> "${accentStagingWebsiteV3.url}" /administration/correspondence/exceptiontypeconfiguration.aspx
